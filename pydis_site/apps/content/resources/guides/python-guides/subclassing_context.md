...
Subclassing Context can be very beneficial as it allows you to set custom Context methods that can be used in your code. Some applications and exmpleds are provideded below.
...
class CustomContext(commands.Context):
    ...
    async def send_embed(self, message, **kwargs):
        return await self.send(embed=discord.Embed(description=message, colour=discord.Color.blurple(), **kwargs))
    ...
    async def send_error_embed(self, message, **kwargs):
        return await self.send(embed=discord.Embed(description=message, colour=discord.Color.red(), **kwargs))
...
class Bot(commands.Bot):
    ...
    async def get_context(self, message, *, cls=CustomContext): # When overriding this method, you pass your new Context class to the super() method indicating that there is a new Context class the bot will use.
